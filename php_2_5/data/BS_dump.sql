...
INSERT INTO `carts` VALUES ('111',NULL,1,2,52,104),('111',NULL,3,1,52,52),('111',NULL,4,1,52,52);
...
INSERT INTO `products` VALUES (1,'MANGO PEOPLE T-SHIRT',1,52.00,NULL),(2,'MANGO PEOPLE Sleeveless Top',2,52.00,NULL),(3,'MANGO PEOPLE Jacket',1,52.00,NULL),(4,'MANGO PEOPLE Top',2,52.00,NULL),(5,'MANGO PEOPLE Sleeveless Top',2,52.00,NULL),(6,'MANGO PEOPLE Linen Blazer',1,52.00,NULL),(7,'MANGO PEOPLE Linen Pants',1,52.00,NULL),(8,'MANGO PEOPLE Linen Shorts',1,52.00,NULL),(9,'MANGO PEOPLE T-SHIRT',1,150.00,NULL),(10,'MANGO PEOPLE T-SHIRT',1,150.00,NULL),(11,'MANGO PEOPLE T-SHIRT',1,150.00,NULL),(12,'MANGO PEOPLE T-SHIRT',1,52.00,NULL),(14,'MANGO PEOPLE JACKET',1,52.00,NULL),(15,'MANGO PEOPLE T-SHIRT',1,150.00,NULL);
...
INSERT INTO `users` VALUES (1,'al@hotmail.com','Alex','J','al@hotmail.com',89995551212,'123','21458440676182b331513308.64593064'),(2,'li@gmail.com','Lisa','Ko','li@gmail.com',89995551213,'123','5128995786179383d6b9af2.41200512'),(3,'jj@hotmail.com','Jane','Wo','jj@hotmail.com',89871234567,'123','5128995786179383d6b9af2.41200755'),(4,'woooo@mail.ru','Kate','Fr','woooo@mail.ru',79083457676,'123',NULL),(5,'admin@admin.com','Serj','Lo','admin@admin.com',89875551155,'123',NULL);
...
/*!50001 VIEW `order_info` AS select `carts`.`session_id` AS `session_id`,`carts`.`quantity` AS `quantity`,`carts`.`price` AS `price`,`carts`.`subtotal` AS `subtotal`,`products`.`id` AS `id`,`products`.`name` AS `name` from (`carts` join `products` on((`carts`.`product_id` = `products`.`id`))) */;
...
-- Dump completed on 2021-11-22 19:13:00
