...
'caption' => 'HOT DEALS',
    ...
    public function renderCard($product, $category)
    {
        static::getTwig();

        echo static::$twig->render('card.twig', [
            'navigation' => $this->navigation,
            'product' => $product,
            'category' => $category,
            'userName' => $_SESSION['name'],
    ...
    public function renderOrdering($goods, $user)
    {
        static::getTwig();

        echo static::$twig->render('ordering.twig', [
            'navigation' => $this->navigation,
            'goods' => $goods,
            'user' => $user,
            'count' => (new CartRepo())->getCountWhere('quantity','session_id', session_id()),
