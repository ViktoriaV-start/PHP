...
<head>
    ...
    <link href="fontawesome/fontawesome/webfonts" rel="stylesheet">
...
<body>
    <header class="header-wrapper">
        ...
        <div class="header__buttons">
            ...
            <button class="header__btn-account">My Account</button>
        </div>
    </div>
    </header>

    <nav class="navigation">
        <div class="php_item"><?php echo $title; ?></div>
        <a href="#" class="php_item">HOME</a>
        <a href="#">MEN</a>
        <a href="#">WOMEN</a>
        <a href="#">KIDS</a>
        <a href="#">ACCESORIES</a>
    ...
    <section class="intro__wrapper">
        <div class="intro container">
            <div class="intro__text">
                <span class="intro__text1">THE BRAND</span>
                <span class="intro__text2">OF LUXERIOUS<span class="intro__text3">FASHION</span></span>
            </div>
        </div>
    </section>

    <section class="poster container">
        <div class="poster__column_gap">
            <div class="poster__item poster__item_mrg">
                <img src="img/man.jpg" alt="Product">
                <h1 class="poster__men">
                    <span class="poster__header"><?php echo $offer; ?></span>
                    <span class="poster__text">FOR MEN</span>
                </h1>
            </div>
            <div class="poster__item poster__down">
                <img src="img/accesory.jpg" alt="Product">
                <div class="poster__accessory">
                    <span class="poster__header">LUXURIOUS & TRENDY</span>
                    <span class="poster__text">ACCESSORIES</span>
                </div>
            </div>
        </div>
        <div class="poster__column">
            <div class="poster__item poster__item_mrg">
                <img src="img/woman.jpg" alt="Product">
                <div class="poster__women">
                    <span class="poster__header">30% OFFER</span>
                    <span class="poster__text">WOMEN</span>
                </div>
            </div>
            <div class="poster__item poster__down">
                <img src="img/kid.jpg" alt="Product">
                <div class="poster__kids">
                    <span class="poster__header">NEW ARRIVALS</span>
                    <span class="poster__text">FOR KIDS</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="footer-end">
        <span class="footer-end__copy-right">&copy; 2017 Brand All Rights Reserved</span>  
        <span class="footer-end__copy-right php_item"><?php echo $date; ?></span>  
        <div class="footer-end__socials">
            <i class="footer-end__social-item fab fab fa-facebook-f"></i>
            <i class="footer-end__social-item fab fa-twitter"></i>
            <i class="footer-end__social-item fab fa-instagram"></i>
            <i class="footer-end__social-item fab fa-pinterest-p"></i>
            <i class="footer-end__social-item fab fa-google-plus-g"></i>
        </div>
    </footer>
